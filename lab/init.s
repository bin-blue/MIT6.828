...
.LM23:
	movl	$6581362, 4(%rsp)
	.stabn	68,0,39,.LM24-.LFBB2
.LM24:
	call	cprintf
	.stabn	68,0,40,.LM25-.LFBB2
.LM25:
	movl	$.LC6, %edi
	movl	$3, %esi
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,43,.LM26-.LFBB2
.LM26:
	movl	$5, %edi
	call	test_backtrace
	.p2align 4,,10
...
# 71 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,73,.LM34-.LFBB3
.LM34:
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,74,.LM35-.LFBB3
.LM35:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC8, %edi
...
.LM36:
	...
	leaq	32(%rsp), %rax
	movq	%rax, 16(%rsp)
	.stabn	68,0,74,.LM37-.LFBB3
.LM37:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,75,.LM38-.LFBB3
.LM38:
	movq	%rbx, %rdi
	movq	%rsp, %rsi
	call	vcprintf
	.stabn	68,0,76,.LM39-.LFBB3
.LM39:
	movl	$.LC9, %edi
	xorl	%eax, %eax
	call	cprintf
